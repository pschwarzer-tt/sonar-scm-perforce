...
public class PerforceConfiguration
{
  ...
  static final String USESSL_PROP_KEY = "sonar.perforce.useSsl";
  static final String USER_PROP_KEY = "sonar.perforce.username";
  static final String PASSWORD_PROP_KEY = "sonar.perforce.password.secured";
  static final String CLIENT_PROP_KEY = "sonar.perforce.clientName";
  static final String CLIENT_IMPERSONATED_HOST_PROP_KEY = "sonar.perforce.clientImpersonatedHostname";
  static final String CHARSET_PROP_KEY = "sonar.perforce.charset";
  static final String SOCKSOTIMEOUT_PROP_KEY = "sonar.perforce.sockSoTimeout";
  ...
  {
    return settings.getBoolean(USESSL_PROP_KEY).orElse(false);
  }
  ...
  {
    return settings.getInt(SOCKSOTIMEOUT_PROP_KEY).orElse(RpcPropertyDefs.RPC_SOCKET_SO_TIMEOUT_DEFAULT);
  }

  @Override
  public String toString()
  {
    return "PerforceConfiguration{" +
      "port=" + port() + ", "
      + "client=" + clientName() + ", "
      + "user=" + username() + ", "
      + "charset=" + charset() + ", "
      + "useSsl=" + useSsl() + ", "
      + "clientImpersonatedHostname=" + clientImpersonatedHostname() + ", "
      + "sockSoTimeout=" + sockSoTimeout() + ", "
      + '}';
  }
}
